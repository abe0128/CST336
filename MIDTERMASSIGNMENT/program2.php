...
$sqlone = "SELECT firstName, lastName, country_of_birth FROM celebrity WHERE gender = 'F' AND NOT (country_of_birth = 'USA') ORDER BY lastName";

$qltwo = "SELECT movie_category, count(movie_title) AS Number_of_Movies, avg(duration) AS Average_Duration FROM movie GROUP BY movie_category";

$sqlthree = "SELECT movie_title, movie_category, duration, company, release_year FROM movie \n"
    . "WHERE release_year > 2000 \n"
    . "ORDER BY duration DESC \n"
    . "LIMIT 3\n"
    . "";
    
$sqlfour = "SELECT lastName, firstName FROM celebrity c
            LEFT JOIN oscar o
